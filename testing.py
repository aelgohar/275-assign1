...
edmonton_graph, location = server.load_edmonton_graph("edmonton-roads-2.0.1.txt") # create the CostDistance instance
...
(4,5), (5,4), (5,6), (6,1), (6,3), (6,5)]) # lengths of the edges described explicitly
...
class SimpleDist:
    ...
    cost2 = SimpleDist()
    # test the least_cost_path function print(server.least_cost_path(graph, 1, 5, cost2))
